...
for fold in range(1, 6):
    ...
    model.encoder_P.load_state_dict(
        torch.load(
            os.path.join(
    ...
    print("HLA Train:")
    path_all = os.path.join(_project_root, "trained_model", "HLA_2")
    save_path = os.path.join(
        _project_root, "trained_model", "HLA_2", "model_HLA_fold{}.pkl".format(fold)
    )
