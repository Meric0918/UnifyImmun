...
for fold in range(1, 6):
    ...
    print("TCR Train:")
    path_all_tcr = os.path.join(_project_root, "trained_model", "TCR_1")
    save_path_tcr = os.path.join(
        _project_root, "trained_model", "TCR_1", "model_TCR_fold{}.pkl".format(fold)
    )
    encoder_path_tcr = os.path.join(
        _project_root, "trained_model", "TCR_1", "encoder_P_{}.pth".format(fold)
    )
